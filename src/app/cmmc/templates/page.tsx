  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-4xl px-4 py-12">
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <a
                  ...
                  download
                  className="flex-shrink-0  border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-900 hover:border-emerald-500 hover:bg-emerald-50"
                >
                  Download CSV
                </a>
              </div>
        ...
        <section className="mt-12  border border-slate-200 bg-slate-900 p-8 text-white shadow-sm">
          ...
          <Link
            href="/sign-up"
            className="inline-flex  bg-amber-400 px-5 py-3 text-sm font-bold text-slate-900 hover:bg-amber-300"
          >
