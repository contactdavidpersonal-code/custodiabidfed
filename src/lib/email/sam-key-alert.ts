  ...
  const html = `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;line-height:1.55;color:#10231d">
      ...
      <table style="border-collapse:collapse;margin:18px 0;font-size:14px">
        ...
        <tr><td style="padding:4px 12px 4px 0;color:#5a7d70;vertical-align:top"><b>SAM.gov response</b></td><td><pre style="background:#e9efea;padding:8px;border-radius:0;white-space:pre-wrap;margin:0">${snippet}</pre></td></tr>
      </table>
      <p><b>To fix:</b></p>
      <ol>
