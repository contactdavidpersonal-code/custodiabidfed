...
- $149 per month for Self Service (Federal Compliance Grant, locked through Sept 30 — was $197 list). Includes me 24/7 (the in-product version with full tooling), evidence collection, the signed annual artifact pack, audit-ready exports, continuous monitoring, and a daily federal opportunity feed.
