...
export const clerkAppearance = {
  ...
  elements: {
    rootBox: "w-full",
    card:
      "bg-white border border-[#cfe3d9] shadow-[0_2px_0_rgba(14,48,37,0.04),0_18px_44px_rgba(14,48,37,0.10)] ",
    cardBox: "",
    headerTitle:
      "font-serif text-[#10231d] tracking-tight",
    headerSubtitle: "text-[#5a7d70]",
    socialButtonsBlockButton:
      " border border-[#cfe3d9] bg-white text-[#10231d] hover:bg-[#f1f6f3] transition-colors",
    ...
    formFieldInput:
      " bg-white border border-[#cfe3d9] text-[#10231d] placeholder:text-[#9ab8ac] focus:border-[#2f8f6d] focus:ring-2 focus:ring-[#2f8f6d]/20",
    formButtonPrimary:
      " bg-[#0e2a23] text-[#bdf2cf] font-bold tracking-tight hover:bg-[#10231d] shadow-none normal-case",
    ...
    userButtonPopoverCard:
      " bg-white border border-[#cfe3d9] shadow-[0_18px_50px_rgba(14,48,37,0.18)]",
